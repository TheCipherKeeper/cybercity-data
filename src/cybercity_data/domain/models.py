...
Schema goals for v3.0:
  ...
  * Honeypot services (`honeypot` block) are ordinary services marked as honeypot / bait-purpose.
...
class HoneypotBlock(_StrictModel):
    """Marks a service as a honeypot / bait-purpose service."""

    kind: HoneypotKind = "http"
    fingerprint: HoneypotFingerprint = "realistic"
...
class Service(_StrictModel):
    ...
    honeypot: HoneypotBlock | None = None
